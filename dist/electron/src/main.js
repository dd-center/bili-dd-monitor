    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                electron_1.ipcMain.on('getFollowLists', function (event) {
                    event.returnValue = services_1.getFollowLists();
                });
                electron_1.ipcMain.on('addFollowList', function (event, name) {
                    services_1.addFollowList(name);
                    event.returnValue = services_1.getFollowLists();
                    ;
                });
                electron_1.ipcMain.on('deleteFollowList', function (event, id) {
                    services_1.deleteFollowList(id);
                    event.returnValue = services_1.getFollowLists();
                    ;
                });
